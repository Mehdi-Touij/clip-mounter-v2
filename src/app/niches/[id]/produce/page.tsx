...
import { ArrowLeft, Loader2, Sparkles, Rss, RotateCcw, ExternalLink } from "lucide-react";
import { Button } from "@/components/ui/button";

interface News { id: string; title: string; link: string; source: string; published_at: string; summary: string }
interface Idea { id: string; title: string; angle: string; rationale: string; priority: number }
